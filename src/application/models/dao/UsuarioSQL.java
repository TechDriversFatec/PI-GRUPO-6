...
public class UsuarioSQL extends ConnectionBase{
	...
	/*public UsuarioSQL() {
		...
		try {
			PreparedStatement stm = conexao.prepareStatement("CREATE TABLE IF NOT EXISTS usuario ("+
	...
	public void create(Usuario user) {
		...
		try {
			PreparedStatement stm = conexao.prepareStatement("INSERT INTO usuario( nome_user, cpf_user, login_user, senha_user, tipo_user) VALUES(?,?,?,?,?);");
